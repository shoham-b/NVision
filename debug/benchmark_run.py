...
def main(
    ...
    console = Console()
    console.print(f"[bold blue]SBED Benchmark[/bold blue]: steps={steps}, particles={particles}, points_per_feature={points_per_feature}")
    ...
    if len(next_times) > 0:
        console.print(f"  Step 1 (JIT warm-up):")
    ...
    if len(next_times) > 1:
        ...
        console.print(f"  Subsequent Steps (Average):")
