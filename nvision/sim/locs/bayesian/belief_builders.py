...
def nv_center_smc_belief(  # noqa: C901
    ...
    **_extra: object,
    ...
    ``with_fixed_frequency`` (default ``True``, matching every NV-center model's own
    default) treats "frequency" as a known instrument constant rather than a free/
    inferred particle dimension; set ``False`` to infer it as well.
