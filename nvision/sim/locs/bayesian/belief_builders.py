...
def nv_center_smc_belief(  # noqa: C901
    ...
    **_extra: object,
    ...
    ``with_fixed_frequency=False`` makes ``frequency`` a free/inferred particle dimension
    (with its sin^2 prior applied) instead of the default fixed physical constant.
