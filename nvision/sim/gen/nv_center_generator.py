...
class NVCenterCoreGenerator:
    ...
    sigma_inhom: float | None = (
        None  # if set, fix inhomogeneous width, Hz (saturation_voigt; also voigt, converted to lorentz_frac via linewidth -- ignored if lorentz_frac is also set)
    )
