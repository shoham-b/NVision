...
def merge_locator_results_with_existing(
    ...
    try:
        ...
        # 'measurements' is deliberately excluded: it must fall through to the
        # generic dtype-alignment pass below so an Int64/Float64 mismatch
        # between the on-disk CSV and fresh results promotes to Float64
        # instead of silently truncating back to Int64.
