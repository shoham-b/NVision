...
def merge_locator_results_with_existing(
    ...
    try:
        ...
        # 'measurements' is intentionally excluded: it can legitimately be a float
        # (e.g. an average across repeats), so its type is resolved by the generic
        # numeric-promotion logic below instead of being forced to Int64 here.
