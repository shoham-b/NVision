...
def merge_locator_results_with_existing(
    ...
    try:
        ...
        # 'measurements' is deliberately excluded: it can legitimately be Int64 in one
        # frame and Float64 in the other, and the generic numeric-alignment pass below
        # (which promotes such mismatches to Float64) must be allowed to handle it.
