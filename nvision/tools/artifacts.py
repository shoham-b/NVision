...
def merge_locator_results_with_existing(
    ...
    try:
        ...
        # 'measurements' is deliberately excluded: it can legitimately be Float64 (e.g. averaged
        # across repeats), and forcing it to Int64 here would truncate that before the generic
        # numeric-type reconciliation loop below gets a chance to promote to Float64 instead.
