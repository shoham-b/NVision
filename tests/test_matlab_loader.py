...
# ---------------------------------------------------------------------------
# _MatlabRunSummary / _echo_convergence_breakdown from matlab_cmd
# ---------------------------------------------------------------------------


def test_convergence_breakdown_counts_and_labels(capsys):
...
def test_convergence_breakdown_all_converged(capsys):
    from nvision.cli.matlab_cmd import _echo_convergence_breakdown, _MatlabRunSummary
    ...
    assert "Split converged: 2/2" in out
    assert "All converged: 2/2" in out
    assert "not converged" not in out


def test_convergence_breakdown_none_converged(capsys):
    from nvision.cli.matlab_cmd import _echo_convergence_breakdown, _MatlabRunSummary
