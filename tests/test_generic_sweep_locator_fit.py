...
@pytest.mark.timeout(600)  # curve_fit's per-point Python loop (generic_sweep_locator.py's
# curve_fn) runs ~290s under the default `--cov=nvision` coverage instrumentation for this
# many-candidate/many-point real-scale fit — well past the 180s this used before coverage
# tracing overhead was accounted for, causing spurious pytest-timeout failures.
