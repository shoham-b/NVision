...
class TestMetricsEdgeCases(unittest.TestCase):
    ...
    def test_single_truth(self):
        ...
        result = _scan_attempt_metrics(truth, estimate)
        assert result["abs_err_x"] == 0.10000000000000009
    ...
    def test_two_truth_happy_path(self):
        ...
        result = _scan_attempt_metrics(truth, estimate)
        assert result["abs_err_x1"] == 0.10000000000000009
        assert result["abs_err_x2"] == 0.10000000000000009
        assert result["pair_rmse"] == 0.10000000000000009
        assert result["uncert"] == 0.1
